package com.fridayapp.attendancetracker.Extras;
...
public class AppPreference {
    ...
    // For Name
    public void setDisplayId(String name){
    ...
    public void setDisplayImage(String image){
        editor.putString(String.valueOf(R.string.s_pref_image), image);
        editor.commit();
    }
    public String getDisplayImage(){
        return sharedPreferences.getString(String.valueOf(R.string.s_pref_image), "image");
    }
    //For email
